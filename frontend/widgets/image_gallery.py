from PyQt6.QtWidgets import (
    ...
    QLabel, QFrame, QPushButton, QFileDialog, QDialog,
...
class ImageThumbnail(QFrame):
    ...
    def init_ui(self):
        ...
        self.prompt_label.setStyleSheet("color: #e0e0e0; font-size: 13px; padding: 4px 0;")
        self.prompt_label.setMaximumHeight(40)
    ...
    def mousePressEvent(self, event: QMouseEvent):
        """Handle mouse click - open preview ONLY on image click"""
        if event.button() == Qt.MouseButton.LeftButton:
            # Get the widget that was clicked
            clicked_widget = self.childAt(event.position().toPoint())
            
            # Only open preview if click was directly on the image label
